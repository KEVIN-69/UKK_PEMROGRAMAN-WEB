...
<br>
    ...
    <form class="d-flex" action="homepage.php" method="GET">
      ...
      <div class="input-group-append">
              <button class="btn btn-primary" type="submit" value="Cari" style="color:white;">
      ...
      <h4 class="text-center font-weight-bold m-4">Daftar Buku Terbaru</h4>
    ...
    ?>
      ...
      <div class="container">
          ...
          <a href="detailbuku.php?id=<?php echo $data['id_buku'] ?>">
            <div class="card col-ke4">
            <tr>
                <td><img src="imgbuku/<?php echo $data['gambar']; ?>" class="card-img-top" height="200"></td>
                <p>Judul Buku : </p>
